...
export const slideStories = [
...

  {
    ...
    caption:
      'Có lẽ ông trời cũng không nỡ để chúng mình lạc mất nhau, nên vì nhiều lý do mà lại nảy sinh ra cuộc gặp này. Nhưng dù sao với anh đây chính là một món quà lớn nhất của năm 2022.',
  },

  {
    title: 'Tình yêu bắt đầu, một cuộc sống thật màu hồng',
    caption:
      'Một tình yêu mà tôi hàng mong đợi, tôi luỵ em trong suốt bao nhiêu lâu cuối cùng cũng được nắm lấy đôi bàn tay ấy. Thời gian này anh như đắm chìm vào con đĩ tình yêu, không quan tâm đến bất kỳ điều gì, cả cuộc sống của anh chỉ muốn xoay quanh em, lúc nào cũng muốn dính lấy nhau.',
  },

  {
    title: 'Cuộc sống thử của đôi bạn trẻ',
    caption:
      'Với anh, đây có lẽ là lúc chúng mình bắt đầu bước sang một cuộc sống mới. Có một người bạn cùng phòng, nhưng người đó lại chính là người mình yêu. Cảm giác lúc ấy lạ lắm, vừa vui, vừa hạnh phúc, mà cũng có chút gì đó khó tả. Tuy nhiên ngoài những lúc vui vẻ, hạnh phúc thì cũng không tránh khỏi những lúc bất đồng và giận dỗi tuy nhiên anh sẽ luôn giữ lấy những khoảng khắc đẹp và hạnh phúc bên nhau như một kỷ niệm cuổi tuổi trẻ.',
  },

  {
    title: 'Tâm sự, sẻ chia với nhau tất cả mọi thứ trên đời',
    caption:
  ...
  {
    title: 'Chúng đều là những ngọn lửa, hãy thừa nhận đi',
    caption:
...

  {
    ...
    caption:
      'Mặc dù có những lúc cãi vã, vì tức giận nên đôi khi anh đã nói những lời không hay. Nhưng thật sự em là một cô gái rất hiểu chuyện, luôn biết quan tâm và lo lắng cho anh mà chẳng toan tính điều gì cả. Những điều đó khiến anh càng thấy yêu và trân trọng em nhiều hơn. Hơn thế nữa em còn đối xử với anh như là bảo mẫu ấy, chỉ cần anh đói là em có thể sẵn sàng vào bếp lúc 2h sáng để nấu cho anh ăn, dành cho anh những món quà bất ngờ, dù không nói ra nhưng những điều ấy khiến anh cảm thấy hạnh phúc lắm, cảm ơn em rất nhìuu.',
  },
